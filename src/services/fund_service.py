...
## 分类规则
1. 只分类到A股行业板块，如：黄金、有色、芯片、AI、医药、证券、银行、军工、光伏、新能源车、锂电池、白酒、消费、农业、煤炭、钢铁、石油、化工、电力、机器人、通信、游戏、传媒、房地产、家电、环保、港股、互联网
2. 相似板块统一名称：券商→证券，医疗→医药，贵金属→黄金，半导体→芯片，人工智能→AI，恒生科技→港股
